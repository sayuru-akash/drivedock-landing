...
export const heroContent: HeroContent = {
  ...
  subheadline:
    "Native macOS app for uploading files and folders to Google Drive with speed, clarity, and control. Built with Swift and SwiftUI.",
  heroImage: {
...
export const features: Feature[] = [
  {
    ...
    description:
      "Drop files or folders directly onto the window, menu bar, or Dock icon to start uploading instantly.",
  },
  {
    id: "folder-structure",
    icon: "folder",
  ...
  },
  {
    ...
    description:
      "Upload multiple files simultaneously with adaptive concurrency that adjusts based on network conditions.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Connect multiple Google accounts and switch between personal, work, and Shared Drive accounts without friction.",
  },
  {
    id: "shared-drive",
    icon: "share",
    ...
    description:
      "Browse and upload to Google Shared Drives you have access to, with full permission awareness.",
  },
  {
    id: "menu-bar",
    icon: "menu",
    ...
    description:
      "A persistent menu bar icon shows upload progress, active count, a quick drop zone, and account switching.",
  },
  {
    id: "upload-history",
    icon: "clock",
...
export const downloadContent = {
  ...
  description:
    "Download the latest version and start uploading with speed and control.",
